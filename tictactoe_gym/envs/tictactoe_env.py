...
class TicTacToeEnv(Env):
    ...
    def Is_valid_action(self, action):
        return self._is_valid_action(action)
    ...
    def _is_game_over(self):
        ...
        if len(self._history) == self.action_space.n:
            #Ninniri's note: self._winner = 0 is 100% incorrect. This basically says that
            #if the game is won at the very last move it's a draw anyway
            
            #EDIT 2: yeah but since we moved this below the other returns it 
